...
Func GoldElixirChange()
	...
	While 1
		...
		While TimerDiff($iBegin) < $x
			If $FoundDarkSideAtk = 1 And $DEEndEarly = 1 And ($dropKing = True Or $dropQueen = True) Then
			   DELow()
		...
		WEnd
		If ($Gold1 = $Gold2 And $Elixir1 = $Elixir2) Or ($Gold2 = "" And $Elixir2 = "") Or ($DarkLow = 1)Then
